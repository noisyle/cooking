	                    ...
	                    <div class="row">
		                    ...
		                    <div class="col-sm-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <input class="form-control" id="intro" name="intro" required>
		                            </div>
		                        </div>
		                    </div>
		                </div>
		                <div class="row">
		                    <div class="col-sm-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <input type="hidden" class="form-control" id="catid" name="catid" required>
		                            </div>
		                        </div>
		                    </div>
		                </div>
...
$(function() {
    ...
    $.ajax("${ctx}/admin/cuisineCats", {
        dataType: "json"
    }).done(function(data) { if(data.length) $("#catid").select2("data", data[0]); });
